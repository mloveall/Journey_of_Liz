...
{
    class MarioSpriteSmallRunning : IMarioSprite
    {
        ...
        public MarioSpriteSmallRunning(IMarioSprite previousSprite)
        {
            ...
            Sprite = ContentManager.Load<Texture2D>("Marios/small_mario_moving");
