...
{
    class MarioSpriteSmallCrouch : IMarioSprite
    {
        ...
        public MarioSpriteSmallCrouch(IMarioSprite previousSprite)
        {
            ...
            Sprite = ContentManager.Load<Texture2D>("Marios/small_mario_idle");
