...
{
    class MarioSpriteSmallJumping : IMarioSprite
    {
        ...
        public MarioSpriteSmallJumping(IMarioSprite previousSprite)
        {
            FacingRight = previousSprite.FacingRight;
            ContentManager = previousSprite.ContentManager;
            SpritePosition = new Vector2(previousSprite.SpritePosition.X, previousSprite.SpritePosition.Y - (spriteHeight - previousSprite.DestRectangle.Height)); ContentManager = previousSprite.ContentManager;
            ...
            Sprite = ContentManager.Load<Texture2D>("Marios/small_mario_jump");
        ...
        public MarioSpriteSmallJumping(ContentManager content)
        {
