...
{
    /// <summary>
    /// The orange end of the portal block system.
    /// </summary>

    class OrangePortalBlock : Block
    {
        ...
        BluePortalBlock outPortal;
        Texture2D usedTexture;
        float timer = 0f;

        // Constructor
        public OrangePortalBlock(Texture2D texture, Texture2D usedTexture, Vector2 location, int portalIndex) : base(texture, location)
        {
            height = 32;
            width = 32;
        ...
        public void setOutPortal(BluePortalBlock bpBlock)
        {
            outPortal = bpBlock;
        }
    }
