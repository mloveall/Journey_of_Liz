...
{
    class MarioSpriteBigJumping : IMarioSprite
    {
        ...
        public MarioSpriteBigJumping(IMarioSprite previousSprite)
        {
            ...
            Sprite = ContentManager.Load<Texture2D>("Marios/big_mario_jump");
