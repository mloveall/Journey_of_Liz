...
{
    class MarioSpriteBigRunning : IMarioSprite
    {
        ...
        public MarioSpriteBigRunning(IMarioSprite previousSprite)
        {
            ...
            Sprite = ContentManager.Load<Texture2D>("Marios/big_mario_moving");
