...
{
    class MarioSpriteBigCrouch : IMarioSprite
    {
        ...
        public MarioSpriteBigCrouch(IMarioSprite previousSprite)
        {
            ...
            Sprite = ContentManager.Load<Texture2D>("Marios/big_mario_crouch");
