...
{
    class MarioSpriteFireCrouch : IMarioSprite
    {
        ...
        public MarioSpriteFireCrouch(IMarioSprite previousSprite)
        {
            ...
            Sprite = ContentManager.Load<Texture2D>("Marios/fire_mario_crouch");
