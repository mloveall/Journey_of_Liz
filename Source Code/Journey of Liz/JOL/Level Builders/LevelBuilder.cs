...
namespace JOL
{
    ...
    public class LevelBuilder
    {
        ...
        Texture2D blockUsedTexture, blockBrickTexture, blockFloorTexture, blockHiddenTexture, blockQuestionTexture, blockStairPyramidTexture, blockBluePortalTexture, blockOrangePortalTexture, blockJumpTexture;
        ...
        public LevelBuilder(ContentManager content)
        {
            ...
            marioTexture = content.Load<Texture2D>("Marios/small_mario_idle");
            blockBrickTexture = content.Load<Texture2D>("Blocks/brickBlock");
            blockFloorTexture = content.Load<Texture2D>("Blocks/floorBlock");
            ...
            itemFireFlowerTexture = content.Load<Texture2D>("Items/fireFlowerSprite");
            itemMushroomTexture = content.Load<Texture2D>("Items/mushroomSprite");
            itemOneUpMushroomTexture = content.Load<Texture2D>("Items/oneUpMushroomSprite");
            itemStarTexture = content.Load<Texture2D>("Items/starSprite");
            enemyGoombaTexture = content.Load<Texture2D>("Enemies/goombaSprite");
            enemyKoopaTexture = content.Load<Texture2D>("Enemies/koopaSprite");
        ...
        public Level BuildLevel(Game1 game, int levelNum, Level previousLevel)
        {
                ...
                for (int index = 0; index < line.Length; index++)
                {
                    ...
                    switch (character)
                    {
                        ...
                        case 'h': // Load a background hill image
                            {
                                bigHills.Add(new BigHill(bigHillTexture, new Vector2(modifier + i * 32, j * 32 - 36)));
                        ...
                        case 'b': // Load a block, need further analysis to determine which block type it is
                            {
                                ...
                                switch (character)
                                {
                                    ...
                                    case 'f': // Floor block
                                        {
                                            blocks.Add(new FloorBlock(blockFloorTexture, new Vector2(modifier + i * 32, j * 32)));
                                            break;
                                        }
                                    case 'p': // Portal block
                                        {
                        ...
                        case 'i': // Load an item
                            {
                                ...
                                switch (character)
                                {
                                    ...
                                    case 'c': // Coin
                                        {
                                            items.Add(new CoinItem(itemCoinTexture, soundCoin, modifier + i * 32, j * 32, true));
                                            break;
                                        }
                                    case 's': // Star
                                        {
                        ...
                        case 'm': // Load a Mario (character 1)
                            {
                                mario = new Mario(marioTexture, content, new Vector2(modifier + i * 32, j * 32), false);
                                break;
                            }
                        case 'l': // Load a Luigi (character 2)
                            {
                                luigi = new Mario(marioTexture, content, new Vector2(modifier + i * 32, j * 32), true);
                                break;
                            }
            ...
            MultiMarioHolder holder = new MultiMarioHolder(mario, luigi);
            ...
            level = new Level(mario, luigi, items, blocks, enemies, killZones, flagPole, instructionOne, instructionTwo, bigHills, portals, game, camera, hud);
